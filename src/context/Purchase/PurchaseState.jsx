...
export const PurchaseState = (props) => {
    ...
    const addSale = async (item) => {
        ...
        const response = await axios.post('https://bazar-api-r8mo.onrender.com/api/addSale', sale);
    ...
    const getSales = async () => {
        const response = await axios.get(`https://bazar-api-r8mo.onrender.com/api/sales`);
