...
export const ItemState = (props) => {
    ...
    const getItems = async (search) => {
        ...
        const response = await axios.get(`https://bazar-api-r8mo.onrender.com/api/items?q=${search}`);
    ...
    const getItem = async (id) => {
        console.log("id", id);
        const response = await axios.get(`https://bazar-api-r8mo.onrender.com/api/items/${id}`);
        console.log(response.data);
        dispatch({
            type: 'GET_ITEM',
            payload: response.data
